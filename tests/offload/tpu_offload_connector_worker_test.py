...
from jax.sharding import Mesh, NamedSharding, PartitionSpec, AxisType
...
class TestTPUOffloadConnectorWorker(jtu.JaxTestCase):
    ...
    def create_mesh(self, axis_shapes, axis_names):
        ...
        try:
            ...
            return jax.sharding.Mesh(device_array, axis_names, tuple([AxisType.Explicit] * len(axis_shapes)))
        except RuntimeError:
            return None
